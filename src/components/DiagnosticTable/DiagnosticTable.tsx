...
const DiagnosticTable: FC<DiagnosticTableProps> = ({syncData, beanHealth, metrics, bnSpec, genesisTime}) => {
  return (
    <div className='flex-1 flex flex-col space-y-4 md:space-y-0 md:flex-row mt-2 w-full'>
      ...
      <AlertInfo bnSpec={bnSpec} metrics={metrics} syncData={syncData} genesisTime={genesisTime}  />
    </div>
  )
}
